...
entity decodificador_7seg is
    Port ( num : in  integer range 0 to 9;
           hex : out STD_LOGIC_VECTOR(6 downto 0)); --Salida de 7 bits para controlar el display 
end decodificador_7seg;

architecture behavioral of decodificador_7seg is --Arquitectura comportamental
begin
    process(num) 
    begin
